  ...
  return (
    <Container>
      <Content>
        ...
        <p>
          Arnav Singh built the upon.one app as a Free app. This service is
          provided by Arnav Singh at no cost and is intended for use as is.
        </p>{" "}
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which are accessible at upon.one unless
        ...
        <p>This policy is effective as of 2022-07-29</p>{" "}
        <p>
          <strong>Contact Us</strong>
        </p>{" "}
        <p>
          If you have any questions or suggestions about my Privacy Policy, do
          not hesitate to contact me at arnav010singh@gmail.com.
        </p>{" "}
        <p>
